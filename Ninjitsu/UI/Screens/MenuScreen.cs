...
namespace G.UI.Screens
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        public MenuScreen(string menuTitle)
        {
			...
			TitlePosition = new Vector2(150, 100);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            SpriteFont font = ScreenManager.HudFont;
            ...
            Vector2 titleOrigin = font.MeasureString(menuTitle);
            float titleScale = 1.5f;

            titlePosition.Y -= transitionOffset * 100;

            spriteBatch.DrawString(font, menuTitle, titlePosition, Color.Snow, 0, titleOrigin, titleScale, SpriteEffects.None, 0);
